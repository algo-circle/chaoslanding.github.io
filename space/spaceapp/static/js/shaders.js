...
const float mat_shininess=150.0;\n\
\n\
\n\
\n\
void main(void) {\n\
...
gl_FragColor = vec4(I*color, 1);\n\
        ...
        var getShader = function (source, type, typeString) { // Function used to compile a shader
        ...
        var shaderVertex = getShader(shaderVertexSource, GL.VERTEX_SHADER, "VERTEX");           //Compilation of the vertex shader
        ...
        GL.useProgram(SHADER_PROGRAM); // Link has finished, webgl is told that you can use the SHADER_PROGRAM to render
        //GL.uniform1i(SHADERS._sampler, 0); // _sampler is the texture channel number 0
    }
};
